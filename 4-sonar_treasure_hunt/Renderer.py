...
class Renderer:
    def __init__(self):
        self._tens_digits_line: str = self.__get_tens_digits_line()
        self._ones_digits_line: str = self.__get_ones_digits_line()
    ...
    def __get_row_with_coordinates(self, board: list[list[str]], row: int) -> str:
        ...
        ...
        """
        padding: str = self.__get_row_padding(row)
